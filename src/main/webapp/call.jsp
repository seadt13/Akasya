    ...
    <div class="page">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="uindex.jsp">Anasayfa</a>
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="displaycalls.jsp">�a�r�lar�m� G�r</a>
                    </li>
                  </ul>
                  </ul>
                </div>
      ...
      <section class="section parallax-container section-xl">
        <div class="parallax-content">
          ...
          <div class="container">
              <p class="heading-1 product-creative-title">Taksi �a��r</p> <br/>
              ...
              <form action="callredirect.jsp" method="post">
                ...
                <input class="button button-lg button-primary button-raven" type="submit" value="�a��r"/>
              </form>
          </div>
        </div>
      </section>
