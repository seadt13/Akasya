                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="dindex.jsp">Anasayfa</a>
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="displaycalls_driver.jsp">Çaðrýlarý Gör</a>
                    </li>
                  </ul>
                </div>
                  ...
                  %></p><a style="color: #cb2027; margin-left: 20px;" href="logout.jsp">Çýkýþ Yap</a></div>
              </div>
            </div>
        ...
        <div class="parallax-content">
          <div class="container">
            <div class="product-creative-main text-center">
              <a class="button button-lg button-primary button-raven" href="displaycalls_driver.jsp">Çaðrýlarý Gör</a>
            </div>
          </div>
        </div>
      </section>
